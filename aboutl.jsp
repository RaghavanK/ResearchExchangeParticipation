...
<nav id="menu">
    <ul>
        <li>Coins (<span class="count"><c:out value="0"/></span>) </li>
        <li>Participants (<span class="count"><c:out value="3"/></span>) </li>
        <li>Participation (<span class="count"><c:out value="5"/></span>) </li>
        <li><br></li>
