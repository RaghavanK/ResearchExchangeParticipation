...
public class PasswordUtil {
    ...
    */    
    ...
    public static String getSalt() {
        ...
        //System.out.println("#salt::## " + Base64.getEncoder().encodeToString(saltBytes));
    ...
    //To hash password with existing salt
    public static String hashAndSaltedPassword(String password, String salt)
            throws NoSuchAlgorithmException {
        return hashPassword(password + salt);
    }
